...
describe('Toast Component', () => {
  ...
  it('handles long messages correctly', () => {
    const longMessage = 'This is a very long message that should be handled properly by the toast component without breaking the layout or causing any visual issues';
