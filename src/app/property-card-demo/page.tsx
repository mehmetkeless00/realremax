...
const sampleProperties: PropertyWithListing[] = [
  ...
  },
  {
    ...
    latitude: 38.4192,
    longitude: 27.1287,
    slug: 'cozy-studio-for-rent',
    meta_title: 'Cozy Studio for Rent',
    meta_description:
      'Perfect studio apartment for young professionals, fully furnished.',
    og_image_url:
  ...
  },
  {
    ...
    description:
      'Luxurious waterfront condo with marina access and stunning sea views.',
    price: 650000,
    location: 'Marina Bay',
    type: 'condo',
    bedrooms: 3,
    ...
    features: ['Marina Access', 'Balcony', 'Gym', 'Pool'],
    ...
    meta_title: 'Waterfront Condo for Sale',
    meta_description:
      'Luxurious waterfront condo with marina access and stunning sea views.',
    og_image_url:
