...
interface CLSOptimizedImageProps {
  ...
  onError?: () => void;
  fill?: boolean;
  aspectRatio?: number; // For maintaining aspect ratio
  objectFit?: 'cover' | 'contain' | 'fill' | 'none' | 'scale-down';
}

export default function CLSOptimizedImage({
  src,
  alt,
  width,
  height,
  ...
  // If image failed to load, show placeholder with same dimensions
  if (imageError) {
    return (
      <div
        ...
        style={{
          ...
          aspectRatio: fill ? undefined : calculatedAspectRatio,
        }}
      >
