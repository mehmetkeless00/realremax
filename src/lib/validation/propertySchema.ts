...
export const propertySearchSchema = z.object({
  ...
  minSize: z.number().min(0, 'Minimum size cannot be negative').optional(),

  maxSize: z.number().min(0, 'Maximum size cannot be negative').optional(),
});
...
export const propertyFilterSchema = z.object({
  ...
  listingTypes: z.array(z.enum(['sale', 'rent'])).optional(),
...
export const validatePropertyInquiry = (
  data: unknown
